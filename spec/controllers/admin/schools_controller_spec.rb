...
RSpec.describe Admin::SchoolsController, :type => :controller do
  ...
  describe "GET new" do
    it "assigns a new admin_school as @admin_school" do
      ...
      expect(assigns(:admin_school)).to be_a_new(School)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new School" do
        expect {
          post :create, {:admin_school => valid_attributes}, valid_session
        }.to change(School, :count).by(1)
      end

      it "assigns a newly created admin_school as @admin_school" do
        post :create, {:admin_school => valid_attributes}, valid_session
        expect(assigns(:admin_school)).to be_a(School)
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_school as @admin_school" do
        post :create, {:admin_school => invalid_attributes}, valid_session
        expect(assigns(:admin_school)).to be_a_new(School)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested admin_school" do
        school = School.create! valid_attributes
        put :update, {:id => school.to_param, :admin_school => new_attributes}, valid_session
        school.reload
      ...
      it "assigns the requested admin_school as @admin_school" do
        school = School.create! valid_attributes
        put :update, {:id => school.to_param, :admin_school => valid_attributes}, valid_session
        expect(assigns(:admin_school)).to eq(school)
      end
    ...
    describe "with invalid params" do
      it "assigns the admin_school as @admin_school" do
        school = School.create! valid_attributes
        put :update, {:id => school.to_param, :admin_school => invalid_attributes}, valid_session
        expect(assigns(:admin_school)).to eq(school)
      end
